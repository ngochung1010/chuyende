							...
							<div class="col-sm-10 col-sm-offset-1">
								<div class="login-form"><!--login form--> 
									...
									<form onsubmit="return confirm('Xác nhận đặt hàng')" method="POST" action="<?php echo base_url('online-checkout') ?>">
										...
										<input type="text" name="tenkh" require placeholder="Họ & Tên*" />
										<?php echo '<span class="text text-danger">'.form_error('tenkh').'</span>' ?>
										<input type="text" name="diachi" require placeholder="Địa Chỉ*" />
										<?php echo '<span class="text text-danger">'.form_error('diachi').'</span>' ?>
										<input type="text" name="sdt" require minlength="9" maxlength="11" placeholder="Số Điện Thoại*" />
										...
										<!-- <select name="hinhthuc">
											...
											<button type="submit" name="redirect" class="btn btn-success">Thánh Toán Bằng VNPAY</button>
										<br>
