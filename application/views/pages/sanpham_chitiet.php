                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="reviews" >
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <ul>
                                            <li><a><i class="fa fa-user"></i><?php echo $comments->tenkhachhang ?></a></li>
                                        ...
                                        {
                                        ?>
                                        <p><h3>Viết đánh giá của bạn:</h3></p>
                                        <h6>Xếp hạng: </h6>
                                        ...
                                        <form >
                                            <span>
                                                ...
                                                <input type="hidden" class="khachhang_id_comment" value="<?php echo $this->session->userdata('LoggedInKhachHang')['id'] ?> "/>
